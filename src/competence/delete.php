<?php 
    ...
    if(!empty($_GET['Codigo'])){
        $codigo = $_GET['Codigo'];
        $sqlSelect = "SELECT * FROM COMPETENCIA WHERE Codigo=?";
        ...
        $codigo = $_POST['Codigo'];
        $sqlUpdate = "DELETE FROM COMPETENCIA WHERE Codigo = ?";
...
<body>
    ...
    <div>
        <h4 class="custom-form-title">EXCLUSAO DE COMPETÊNCIA</h4>
        <hr>
        ...
        <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select id="foro" disabled name='foro' class="form-control">
