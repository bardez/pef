...
<body>
    ...
    <div class="container p-2">
        <h4 class="custom-form-title">LISTA DE COMPETÊNCIAS <span><a class='btn btn-success' href="insert.php"> + Adicionar</a></span></h4>
        <hr>
        <table class="table table-stripped">
            ...
            <tbody>
                <?php
                    $sql = "SELECT cp.*, f.Nome as fNome FROM COMPETENCIA cp
                    INNER JOIN FORO f ON cp.FORO_Codigo = f.Codigo";
