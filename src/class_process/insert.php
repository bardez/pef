<?php 
    ...
    if(!empty($_POST['Nome'])){
        ...
        $sqlSelect = "SELECT * FROM CLASSE_PROCESSO WHERE Nome='$nome'";
        ...
        if($numRowsSelect> 0)
        {
            ...
            $sqlInsert = "INSERT INTO CLASSE_PROCESSO (Nome, COMPETENCIA_Codigo) VALUES (?,?)";
            $cmd = mysqli_prepare($connection, $sqlInsert);
            mysqli_stmt_bind_param($cmd,'si',$nome, $competencia);
...
<body>
    ...
    <div class="container p-2">
        <h4 class="custom-form-title">CADASTRO DE CLASSE DE PROCESSO</h4>
        <hr>
            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name='Nome' class="form-control" id="Nome" placeholder="Digite a classe">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
